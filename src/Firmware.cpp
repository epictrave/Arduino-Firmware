 ...
 * @author Janghun Lee (jhlee@sangsang.farm)
 */
void Firmware::setVersion(double version)
{
  firmware_data.version = version;
}

/**
 * @fn void Firmware::setEepromDeleteAddress(int eeprom_delete_address)
 * @brief 펌웨어 EEPROM 주소 설정
 * @parm eeprom_delete_address 설정할 EEPROM 주소
 * @return void
 * @date 2019-08-27
 * @author Janghun Lee (jhlee@sangsang.farm)
 */
